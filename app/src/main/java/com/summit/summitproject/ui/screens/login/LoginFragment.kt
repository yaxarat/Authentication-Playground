...
class LoginFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        viewModel.getCiphertextWrapperOrNull(requireActivity())
    }
    ...
    override fun onCreateView(
        ...
        setContent {
            ...
            val ciphertextWrapper: CiphertextWrapper? = viewModel.state.value.ciphertextWrapper
            ...
            Column(
                ...
                TextButton(
                    onClick = { viewModel.showBiometricPromptForDecryption(requireActivity()) },
                    enabled = ciphertextWrapper != null,
                    modifier = Modifier
                        .padding(horizontal = 32.dp, vertical = 32.dp)
                        .fillMaxWidth()
                ) {
                    Text(
                        text = "Sign in using biometric",
